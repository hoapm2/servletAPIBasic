...
<ul
		...
		<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
			...
			<div class="bg-white py-2 collapse-inner rounded">
				...
				<a class="collapse-item"
					href='<c:url value="/admin-new?type=list&page=1&maxItemOnPage=4&sortName=title&sortBy=asc"/>'>List
					New</a> <a class="collapse-item" href="cards.html">Cards</a>
			</div>
		</div></li>
	...
	<!-- Nav Item - Logout-->
	<li class="nav-item"><a class="nav-link" href="<c:url value='/views/login.jsp'/>"> <i
